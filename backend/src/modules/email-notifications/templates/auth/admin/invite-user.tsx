...
export interface InviteUserEmailProps {
    ...
    /**
     * The link that server public assets (images, logos etc.)
     */
    publicUrl?: string;
}
        ...
        <Base preview={preview}>
            ...
            <Section className="text-center">
                <Text className="text-black text-[14px] leading-[24px]">
                    You&apos;ve been invited to be an administrator on <strong>RSPI</strong>.
                </Text>
            ...
            <Text className="text-[#666666] text-[12px] leading-[24px]">
                ...
                invitation will expire in 24 hours. If you are concerned about your account's
