...
export const ADMIN_QUOTE_CREATED = 'admin-quote-created';
...
const AdminQuoteCreatedTemplate = ({
    order,
    shippingAddress,
    publicUrl,
    ...
    return (
        <Base preview={preview}>
            ...
            <Section>
                ...
                <Text>A new quote has just been placed on the store.</Text>
                <Text>Please log in to the admin dashboard to review and process this quote.</Text>
            </Section>
            ...
            <Section className="mt-4">
                ...
                <Text style={{ margin: '0 0 5px' }}>Quote number: {order.display_id}</Text>
                <Text style={{ margin: '0 0 5px' }}>
                    Quote date: {new Date(order.created_at).toLocaleDateString()}
                </Text>
                <Text style={{ margin: '0 0 5px' }}>
...
AdminQuoteCreatedTemplate.PreviewProps = {
...
export default AdminQuoteCreatedTemplate;
